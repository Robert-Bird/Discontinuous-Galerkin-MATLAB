...
% Date:   15/08/2018
% Description: Function to run example problem 1 (see documentation)
...
while exit1==0
    ...
    [node,edge,BC,delta2,delta1,loop_end,av_bc,sim_end,E,v]=...        % Problem definition for analytical problems
        analytical_problem_1_generator;
    ...
    for simulation = 1:sim_end
        ...
        % 1: Generating Mesh ----------------------------------------------
        [coord,etpl,etpl_face] = squaremesh(node,edge,BC);             % Generate mesh
