%% Total func test
% Script for running suite of tests ---------------------------------------
...
% Defines the first test that is performed, this value is then increased by untill 4
testFlag = 1;

% Counter of passes tests (if testFlag=1, complete success is a values of 8)
passcheck = 0;                                                             
